...
function cadastrarprova() {
  var form = '<form id="questionario" action="./includes/cadastraprova.php" name ="questionario" method="POST">';
  ...
  form += '<br>';
  form += '<input type="submit" id="finalizaprova" onclick="parte3cadprova()"  ></input>';
  form += '</form>';
